...
<div class="am-cf admin-main">
    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <h3 class="am-icon-users on"><em></em> <a href="">线路负责人管理</a></h3>
            <ul>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on"> 线路负责人管理</ul>
                <dl class="am-icon-home" style="float: right;"> 当前位置： <a href="">首页</a>>所有负责人列表</dl>

                <dl>
                    <button class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" type="button"> 添加/删除负责人
                    </button>
                </dl>
            </div>
            ...
            <form class="am-form am-g">
                <table class="am-table am-table-bordered am-table-radius am-table-striped" width="100%">
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">线路id</th>
                        <th class="table-title">负责人id</th>
                        <th class="table-type">负责人姓名</th>
                        <th class="table-type">线路名</th>
                    ...
                    <tr>
                        ...
                        <td>${manager.age}</td>
                        <td class="am-hide-sm-only">${manager.createtime}</td>
                        <td class="am-hide-sm-only">${manager.updatetime}</td>
                    </tr>
                    </#list>
